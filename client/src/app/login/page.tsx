    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (data.data?.token) {
          ...
          document.cookie = `userName=${data.data.fullName}; max-age=${
            60 * 60 * 24 * 7
          }; path=/`;
        }
        ...
        console.log("Cookies after setting:", {
          authTokenCookie: document.cookie.match(/authToken=([^;]*)/)?.[1],
          userNameCookie: document.cookie.match(/userName=([^;]*)/)?.[1],
        });
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  <Label htmlFor="phoneNo" className="text-black font-medium">
                    Phone Number *
                  </Label>
