...
const timeframeOptions = [
  {
    id: "1_month",
    label: "1 Month",
    description: "Fast progress with intense focus",
  },
  {
    id: "3_months",
    label: "3 Months",
    description: "Steady progress with moderate changes",
  },
  {
    id: "6_months",
    label: "6 Months",
    description: "Gradual progress with sustainable habits",
  },
  {
    id: "1_year",
    label: "1 Year+",
    description: "Long-term lifestyle change approach",
  },
];

export default function GoalTimeframePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Store goal timeframe in session storage
    ...
    sessionStorage.setItem(
      ...
      JSON.stringify({
        ...userPreferences,
        goalTimeframe: selectedTimeframe,
      })
    );
